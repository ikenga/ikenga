package me.ikenga.base.configuration;
 ...
 */
@Configuration
public class IkengaWebInitializer implements ServletContextInitializer {
	...
	public void onStartup(ServletContext sc) throws ServletException {
		...
		filter.setInitParameter(PARAM_APP_BEAN, "ikengaWebApplication");
